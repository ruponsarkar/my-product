...
const analytic_routes_1 = __importDefault(require("./analytic.routes"));
...
router.use('/categorys', category_routes_1.default);
router.use('/analytics', analytic_routes_1.default);
/**
 * @openapi
 * /api/v1/:
 *   get:
