...
router.get("/:id", product_controller_1.getProductByIdOrSlug);
router.get("/code/:code", product_controller_1.getProductBarcodeOrSku);
router.put("/:id", product_controller_1.updateProduct);
router.get("/getLastSkuNumber/:prefix", product_controller_1.getLastSkuNumber);
// router.post("/:id/image", uploadMany.array("images", 10), addProductImages);
router.post("/deleteProductImages/:id", product_controller_1.deleteProductImages);
